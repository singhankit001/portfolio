...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setLoading(true);
    try {
      const formUrl = "https://docs.google.com/forms/d/e/1FAIpQLScji4q4BGe5JmdC4tAQcLMPmPAtUIVXg-koasMX2x8Yh9mA7Q/formResponse";
      const formData = new URLSearchParams();
      formData.append("entry.2005620554", fullName);
      formData.append("entry.1906728632", email);
