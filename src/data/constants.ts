...
using use = useUsing("use")`,
  ...
  [SkillNames.PRETTIER]: {
    ...
    name: "prettier",
    label: "AI & LLMs",
    shortDescription: "building intelligent systems with Agentic AI, RAG, & LangGraph 🤖🧠",
    color: "#ee4c2c",
  ...
  [SkillNames.FIREBASE]: {
    ...
    label: "Python",
    shortDescription:
      "because writing elegant code shouldn't feel like deciphering hieroglyphs! 🐍🚀",
    color: "#3776ab",
    icon: "/assets/logos/python-svgrepo-com (1).svg",
  },
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Evox Ventures",
    description: [
      "Engineered and deployed the official digital experience for a premium event management brand.",
      "Architected the platform using Next.js and React, implementing edge-optimized performance strategies.",
      "Elevated user engagement through Framer Motion and Tailwind CSS, integrating seamless page transitions.",
      "Developed a dynamic 'Get Quote' inquiry engine, streamlining client scoping.",
    ],
    skills: [
      SkillNames.NEXTJS,
      SkillNames.TS,
  ...
  },
  {
    ...
    company: "SHUTTLE TRACKER",
    description: [
      "Contributed to building a real-time bus tracking system to improve campus transportation efficiency.",
      "Implemented live GPS tracking using map-based APIs (Google Maps/Mapbox).",
      "Developed ETA prediction and route visualization features, enabling efficient travel planning.",
      "Built a responsive, cross-platform user interface for seamless access on mobile and web.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.JS,
